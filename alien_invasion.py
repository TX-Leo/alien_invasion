...
'''加载背景图片'''
pygame.init()
background = pygame.image.load('images/background.jpg')  # 设置背景图片
backgroundposition = background.get_rect()  # 获取背景图片矩形

'''加载开火/撞击音效'''
pygame.mixer.init()  # 初始化混音器
sound1 = pygame.mixer.Sound('music/M1.mp3')  # 设置开火音效
sound1.set_volume(0.2)  # 开火音效声音大小

sound2 = pygame.mixer.Sound('music/M2.mp3')  # 设置撞击音效
sound2.set_volume(0.2)  # 撞击音效声音大小
...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        self.screen=pygame.display.set_mode((self.settings.screen_width,self.settings.screen_height))#创建显示窗口，宽1200像素，高800像素
        ...
        '''载入背景音乐'''
        pygame.mixer.init()#初始化混音器
        pygame.mixer.music.load("music/BG.mp3")#设置背景音乐
        pygame.mixer.music.set_volume(0.2)#设置音量大小
        pygame.mixer.music.play(loops=-1)#-1，表示无限次播放
    ...
    def _update_screen(self):
        ...
        self.screen.blit(background,backgroundposition)  # 每次循环时都重绘屏幕
